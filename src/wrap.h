...
static inline void wrap_find_start(union arg *)
{
    webkit_find_controller_search(
        webkit_web_view_get_find_controller(current_frame_get()->view),
        gtk_clipboard_wait_for_text(gtk_clipboard_get_default(GDK_DISPLAY(gtk_widget_get_display(current_frame_get()->win)))),
...
{
    webkit_find_controller_search_next(webkit_web_view_get_find_controller(current_frame_get()->view));
}

static inline void wrap_find_previous(union arg *)
{
    webkit_find_controller_search_previous(webkit_web_view_get_find_controller(current_frame_get()->view));
}
